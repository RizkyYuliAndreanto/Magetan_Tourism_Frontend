  ...
  <div class="form-card">
    ...
    <form @submit.prevent="submitForm" class="form-container">
      <div class="form-section">
        <h4 class="section-title"><i class="fas fa-bed"></i> Detail Akomodasi</h4>
        <div class="form-grid">
          ...
          <div class="form-group span-2">
            <label for="gambar_akomodasi">Gambar Utama Akomodasi</label>
            <input type="file" id="gambar_akomodasi" @change="handleFileUpload" class="form-input-file">
            <p v-if="formData.gambar_akomodasi" class="mt-2 text-sm text-gray-500">Gambar saat ini: {{ formData.gambar_akomodasi }}</p>
          </div>
          <div class="form-group">
      ...
      <div class="form-actions">
        <button type="submit" class="action-button save-button">
          <i class="fas fa-save"></i> {{ isEditing ? 'Simpan Perubahan' : 'Simpan Akomodasi & Galeri' }}
        </button>
...
const handleFileUpload = (event) => {
  formData.value.gambar_akomodasi = event.target.files[0];
};
