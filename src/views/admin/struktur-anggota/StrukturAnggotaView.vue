      ...
      <main class="content-area">
        <div class="content-wrapper">
          <div class="header-container">
            <h2 class="page-title">Manajemen Struktur Anggota</h2>
            <p class="page-subtitle">Kelola semua data struktur anggota yang ada di website Anda.</p>
          </div>

          <div class="tab-content">
            <StrukturAnggotaManagement />
          </div>
        </div>
      </main>
    </div>
...
import StrukturAnggotaManagement from './StrukturAnggotaManagement.vue';
...
const pageTitle = computed(() => 'Manajemen Struktur Anggota');
</script>
