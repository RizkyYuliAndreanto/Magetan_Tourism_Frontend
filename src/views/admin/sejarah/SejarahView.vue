      ...
      <main class="content-area">
        <div class="content-wrapper">
          <div class="header-container">
            <h2 class="page-title">Manajemen Sejarah</h2>
            <p class="page-subtitle">Kelola semua data sejarah yang ada di website Anda.</p>
          </div>
...
import SejarahManagement from './SejarahManagement.vue';
...
const pageTitle = computed(() => 'Manajemen Sejarah');
</script>
