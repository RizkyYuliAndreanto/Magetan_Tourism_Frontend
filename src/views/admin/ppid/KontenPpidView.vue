    ...
    <main class="content-area">
      <div class="content-wrapper">
        ...
        <div class="tab-navigation">
          <button
            :class="['tab-button', { 'active': currentTab === 'konten' }]"
            @click="changeTab('konten')">
        ...
        <div class="tab-content">
          <KontenPpidManagement v-if="currentTab === 'konten'" />
          <KategoriPpidManagement v-if="currentTab === 'kategori'" />
        </div>
      </div>
    </main>
  </div>
